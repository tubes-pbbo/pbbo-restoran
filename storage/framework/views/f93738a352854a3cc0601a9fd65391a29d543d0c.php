...
<body>
    <?php if(count($menus->menuorder) == 0): ?>
    <center>
    ...
    <center>
        <table class="table-borderless" width="1000px" style="margin : 20px 0 30px 0;height: 70%">
            ...
            <tbody>
                <?php $total = 0 ?>
                <?php $__currentLoopData = $menus->menuorder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><a href="/Cart/<?php echo e($mejas->tableId); ?>/<?php echo e($order); ?>/<?php echo e($query); ?>/<?php echo e($menu->ID); ?>">Delete</a></td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <?php for($i = 0;$i < 20;$i++): ?> <a class="dropdown-item" href="/Cart/<?php echo e($mejas->tableId); ?>/<?php echo e($order); ?>/<?php echo e($query); ?>/<?php echo e($menu->ID); ?>/<?php echo e($i); ?>"><?php echo e($i); ?></a>
                                    <?php endfor; ?>
                            </div>
                        </div>
                    </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="/Bill/<?php echo e($mejas->tableId); ?>/<?php echo e($order); ?>/<?php echo e($total); ?>/cart"><button type="button" class="btn btn-primary">Save changes</button></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <a href="/Bill/<?php echo e($mejas->tableId); ?>/<?php echo e($order); ?>/cart/<?php echo e($total); ?>"><button type="button" class="btn btn-primary">Save changes</button></a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\chris\PBBO\resources\views/cartitem.blade.php ENDPATH**/ ?>